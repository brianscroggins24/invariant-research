...
OptionParser.new do |opts|
  opts.banner = 'Usage: validate_capture_report.rb --file CAPTURE_REPORT.md [--root REPO_ROOT]'
...
errors, = IngestionValidation.validate_capture_report_path(options[:file], base_dir: options[:root])
